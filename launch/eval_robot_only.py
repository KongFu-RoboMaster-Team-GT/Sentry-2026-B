...
def generate_launch_description():
    ...
    robot_xacro_file = 'robot_translated.xacro'           # 你的机器人模型文件名
    model_dir = 'translated_nightbuild'
    ...
    model_abs_dir = os.path.join(robot_desc_share_dir, 'models', model_dir)
    set_gazebo_model_path = SetEnvironmentVariable(
        name='GAZEBO_MODEL_PATH',
        value=model_abs_dir + ':' + os.environ.get('GAZEBO_MODEL_PATH', '')
    )
